...
/* filename : tasks_Nodo_3.c.c                                                         */
/* version  : 1                                                               */
/* date     : 31/05/2021                                                      */
/* author   : Jos� Manuel Vidarte Llera                                       */
/* description : Planificaci�n de tareas Nodo 3 que se comunican por bus CAN  */
/*                                                                            */
/******************************************************************************/
...
int tcomp_n3_task1 = 5;
int tcomp_n3_task2 = 13;
int tcomp_n3_task3 = 10;
...
Void task1(UArg arg0, UArg arg1)
{
    for (;;) {
        ...
        // Esperar a que el nodo 2 acabe de ejecutar su parte de la tarea 1 (msg con id 0x1003)
        ...
        //UARTprintf("Nodo 3: Recibo mensaje de que el nodo 2 ha acabado con su parte de la tarea.\n");

        CS (tcomp_n3_task1) ;

        //Enviar msj de fin de tarea 1 a nodos 1 y 2 (id 0x1000)
        ...
        //UARTprintf("Nodo 3: Envio msg a nodos 1 y 2 para que den por finalizada la tarea 1.\n");
...
Void task2(UArg arg0, UArg arg1)
{
    for (;;) {
        ...
        CS (tcomp_n3_task2) ;
        //Enviar msj de continuaci�n de tarea 2 a nodo 1 (id 0x2001)
        uint32_t ui32MsgData_init = 0;
        ...
        //UARTprintf("Nodo 3: Envio msg a nodo 1 para que continue con la tarea 2 y me quedo esperando confirmaci�n.\n");
        CANMessageSet(CAN0_BASE, 2, &CANMsgObject2_task2, MSG_OBJ_TYPE_TX);

        while(!g_bRXFlag2){}
        g_bRXFlag2 = 0; // Limpiar flag de recepci�n msg2

        // Esperar a que el �ltimo nodo (1) acabe de ejecutar su parte de la tarea 2 (msg con id 0x2000)
        ...
        //UARTprintf("Nodo 3: Recibo mensaje de que el �ltimo nodo (2) ha acabado con el resto de la tarea 2.\n");
    }
}
...
Void task3(UArg arg0, UArg arg1)
{
    for (;;) {
        ...
        // Esperar a que el nodo 2 acabe de ejecutar su parte de la tarea 3 (msg con id 0x3003)
        ...
        //UARTprintf("Nodo 3: Recibo mensaje de que el nodo 2 ha acabado con la primera parte de la tarea 3.\n");

        CS (tcomp_n3_task3) ;

        //Enviar msj de continuaci�n de tarea 3 a nodo 1 (id 0x3001)
        uint32_t ui32MsgData_init = 0;
        ...
        //UARTprintf("Nodo 3: Envio msg a nodo 1 para que continue con la tarea 3.\n");
        ...
        //UARTprintf("Nodo 3: Recibo mensaje de que el �ltimo nodo (1) ha acabado con el resto de la tarea 3.\n");
    }
}
